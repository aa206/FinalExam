...
class CartScreen extends StatefulWidget {
  ...
  const CartScreen({Key? key, required this.user, required this.totalpayable}) : super(key: key);
...
class _CartScreenState extends State<CartScreen> {
  ...
  void _loadCart() {
    http.post(
        Uri.parse(CONSTANTS.server + "/mytutor3/php/load_cart.php"),
        body: {
